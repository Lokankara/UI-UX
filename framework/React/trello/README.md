...
lucide-react class-variance-authority tailwind-merge clsx @clerk/nextjs

npx shadcn@latest init
npx shadcn add button card input label textarea dialog select badge

npm install -D tailwindcss@4.1.12 postcss autoprefixer @tailwindcss/postcss tailwindcss-animate
